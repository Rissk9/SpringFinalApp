...
public class CustomerIdentificationServiceImpl implements CustomerIdentificationService {
	...
	public ResponseEntity<custIndentifDTO> addIdentification(custIndentifDTO dto) {
		...
		CustomerDetail cdetail = custdetailrepo.findById(dto.getCustId())
				.orElseThrow(() -> new RuntimeException("Customer detail id not found"));
	...
	public ResponseEntity<?> updateIdentification(Long id, custIndentifDTO dto) {
		...
		CustomerIdentification saved = repo.findById(id)
				.orElseThrow(() -> new RuntimeException("Identification id not found "));
	...
	public ResponseEntity<?> deleteIdentification(Long id) {
		...
		CustomerIdentification customerIdentification = repo.findById(id)
				.orElseThrow(() -> new RuntimeException("Id not found"));

		if (Objects.equals(customerIdentification.getCrudval(), 'D'))
